    ...
    public function render_leaderboard(array $users, ?int $highlightid = null): string {
        ...
        foreach ($users as $u) {
            ...
            $html .= html_writer::tag('tr',
                ...
                html_writer::tag('td', (string)$u->xp, ['class' => 'xp-col']),
                ['class' => $rowclass]
            );
    ...
    public function render_give_xp_form(): string {
        ...
        <script>
            ...
            function validateXpForm(form) {
                ...
                if (!user && !points) {
                    alert('" . get_string('val_user_points', 'block_gamification') . "');
                    return false;
                }
                if (!user) {
                    alert('" . get_string('val_user', 'block_gamification') . "');
                    return false;
                }
                if (!points || isNaN(points) || points <= 0) {
                    alert('" . get_string('val_points', 'block_gamification') . "');
                    return false;
                }
                return true;
            }
